...
> A design system for developer-week UI components, built on [@design-systems/cli](https://github.com/intuit/design-systems-cli).

## 👍 Philosophy

This is a design system intended for UI components currently being built or tested in developer-week.
...
For an example we will try to use the `@developer-week/card` component.

```sh
npm i @developer-week/card
# or with yarn
yarn add @developer-week/card
```
...
Now whenever you import one of the `@developer-week` components, `babel` will automatically include the correct CSS file!
